      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Sobre de fisioterapias</h1>
              </div>
              <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('dash')}}">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Sobre de fisioterapia</li>
                  </ol>
                </nav>
              </div>
            </div>
              ...
              <div class="col-12">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-header">
                    <div class="row g-2 align-items-center">
                      <div class="col-12 col-md-4">
                        <h3 class="card-title">Sobre de fisioterapia Cadastrados</h3>
                      </div>
                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          @forelse ($listaSobre as $lista)
                          <tr>
                            {{-- ID --}}
                            <td>
                              {{$lista->id_sobre_fisio}}
                            </td>


                            {{-- TÍTULO --}}
                            <td>
                              @if ($lista->titulo_sobre_fisio)
                                <span class="badge text-bg-sucess"> {{$lista->titulo_sobre_fisio}}</span>                              
                              @else
                                  <span>Nenhum sobre Cadastrado</span>
                              @endif
                            </td>

                            {{-- TEXTO --}}
                            <td>
                              <span class="badge text-bg-sucess"> {{$lista->texto_topico_sobre_fisio}}</span>
                            </td>

                            <td>
                              @if($lista->status_sobre_fisio === 'ATIVO')
                  ...
                  <div class="card-footer clearfix">
                   ...
                   Total de sobre de fisioterapia:
                   <strong>
                    {{$listaSobre-> count()}}
                   </strong>
                    </div>
