      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Descrições</h1>
              </div>
              <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('dash')}}">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Descrição</li>
                  </ol>
                </nav>
              </div>
            </div>
                  ...
                  <div class="card-header">
                    <div class="row g-2 align-items-center">
                      <div class="col-12 col-md-4">
                        <h3 class="card-title">Descrições Cadastrados</h3>
                      </div>
                      ...
                      <table class="table table-hover align-middle m-0">
                        <thead>
                          <tr>
                            ...
                            <th>icon</th>
                            <th>Descrição tópico</th>
                            <th>Status</th>
                            <th class="text-end">Ações</th>
                          </tr>
                        </thead>
                        <tbody>
                          @forelse ($listaDescricao as $lista)
                          <tr>
                            {{-- ID --}}
                            <td>
                              {{$lista->id_descricao_servico}}
                            </td>

                            
                            {{-- NOME --}}
                            <td>
                                @if ($lista->titulo_descricao_servico)                                
                                    <span class="badge text-bg-sucess"> {{$lista->titulo_descricao_servico}}</span>
                                @else
                            ...
                            {{-- EMAIL --}}
                            <td>
                                <span class="badge text-bg-sucess">{{$lista->descricao_longa_descricao_servico}}</span>
                            </td>

                            {{-- SENHA --}}
                            <td>
                                <span class="badge text-bg-sucess">{{$lista->icon_topico_descricao_servico}}</span>
                            </td>

                            {{-- FOTO --}}
                            <td>
                                <span class="badge text-bg-sucess">{{$lista->descricao_topico_descricao_servico}}</span>
                            </td>

                            <td>
                              @if($lista->status_descricao_servico === 'ATIVO')
