                  ...
                  <div class="card-header">
                    <div class="row g-2 align-items-center">
                      <div class="col-12 col-md-4">
                        <h3 class="card-title">Sobre Cadastrados</h3>
                      </div>
                      ...
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            {{-- TÍTULO --}}
                            <td>
                              @if ($lista->titulo_sobre)                                  
                                <span class="badge text-bg-sucess"> {{$lista->titulo_sobre}}</span>
                              @else
                            ...
                            {{-- DESCRIÇÃO --}}
                            <td>
                              <span class="badge text-bg-sucess">{{$lista->descricao_sobre}}</span>
                            </td>

                            {{-- ICON --}}

                            <td>
                              <span class="badge text-bg-sucess">{{$lista->icon_topico_sobre}}</span>
                            </td>

                            {{-- TÍTULO TÓPICO --}} 

                            <td>
                              <span class="badge text-bg-sucess">{{$lista->titulo_topico_sobre}}</span>
                            </td>

                            <td>
                              @if($lista->status_sobre === 'ATIVO')
