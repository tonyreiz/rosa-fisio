                  ...
                  <div class="card-header">
                    <div class="row g-2 align-items-center">
                      <div class="col-12 col-md-4">
                        <h3 class="card-title">Avaliações Cadastrados</h3>
                      </div>
                        ...
                        <div class="d-flex flex-wrap justify-content-md-end gap-2">
                          <div class="input-group input-group-sm w-auto">
                            ...
                            <input
                              ...
                              aria-label="Pesquisar Avaliação"
                              style="width: 180px"
                            />
                          </div>
                          <select
                      ...
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            {{-- ESTRELA --}}
                            <td>
                                <span class="badge text-bg-sucess">{{$lista->estrela_avaliacao}}</span>                                  
                            </td>

                            {{-- DESCRICAO --}}
                            <td>
                                @if ($lista->descricao_avaliacao)
                                    <span class="badge text-bg-sucess"> {{$lista->descricao_avaliacao}}</span>
                                @else
