                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          @forelse ($listaServico as $lista)
                          <tr>
                            {{-- ID --}}
                            <td>
                              {{$lista->id_servico_resumo}}
                            </td>
                            ...
                            <td>
                                 ...
                                 <img 
                                 src="{{ asset('rosa/image/' . $lista->imagem_servico_resumo)}}" alt="{{$lista->titulo_servico_resumo}}"
                                 class="rounded"
                                 style="
                                    width: 100px;
                                    height: 75px;
                            ...
                            {{-- TÍTULO --}}
                            <td>
                              <span class="badge text-bg-sucess"> {{$lista->titulo_servico_resumo}}</span>
                            </td>

                            {{-- DESCRIÇÃO --}}
                            <td>
                              <span class="badge text-bg-sucess"> {{$lista->descricao_servico_resumo}}</span>
                            </td>

                            <td>
                              @if($lista->status_servico_resumo === 'ATIVO')
