                      ...
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                @if ($lista->nome_cliente)
                                    <span class="badge text-bg-sucess">{{$lista->nome_cliente}}</span>    
                                @else
                            ...
                            <td>
                                <span class="badge text-bg-sucess">{{$lista->idade_cliente}}</span>
                            </td>

                            {{-- EMAIL --}}

                            <td>
                                <span class="badge text-bg-sucess">{{$lista->email_cliente}}</span>
                            </td>

                            {{-- TELEFONE --}}

                            <td>
                                <span class="badge text-bg-sucess">{{$lista->telefone_cliente}}</span>
                            </td>

                            <td>
                            
                                 <img 
                                 src="{{ asset('rosa/image/' . $lista->foto_cliente)}}" alt="{{$lista->nome_cliente}}"
                                 class="rounded"
                                 style="
                                    width: 100px;
                                    height: 75px;
