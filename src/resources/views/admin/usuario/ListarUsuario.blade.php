                      ...
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            {{-- NOME --}}
                            <td>
                                @if ($lista->nome_usuario)                                
                                    <span class="badge text-bg-sucess"> {{$lista->nome_usuario}}</span>
                                @else
                            ...
                            {{-- EMAIL --}}
                            <td>
                                <span class="badge text-bg-sucess">{{$lista->email_usuario}}</span>
                            </td>

                            {{-- SENHA --}}
                            <td>
                                <span class="badge text-bg-sucess">{{$lista->senha_usuario}}</span>
                            </td>

                            {{-- FOTO --}}
                            <td>
                                <span class="badge text-bg-sucess">{{$lista->foto_usuario}}</span>
                            </td>

                            <td>
                              @if($lista->status_usuario === 'ATIVO')
